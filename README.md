...
/ac threads           what is actually stored, for when the pane disagrees
...
A recap of your last stretch of play is available too, generated by a small
model running locally through [Ollama](https://ollama.com). No API key, no
per-token cost, no game text ever leaves the machine:
